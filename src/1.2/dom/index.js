...
export class DOM {
    ...
    [getNodeByVendorNode](vendorNode) {
        ...
        if (!vendorNode) {
            result = new RemoteNode(vendorNode);
     ...
     */
    highlightRect(x, y, width, height, color = new DOM.RGBA(0, 0,0, 0), outlineColor = new DOM.RGBA(0, 0,0, 0)) {
...
Object.assign(DOM, {
    getNodeByVendorNode,
    getVendorNodeByNodeId,
    getChildrenByVendorNode,
